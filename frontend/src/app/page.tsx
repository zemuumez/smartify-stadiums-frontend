...
import {
  ...
  CheckCircle2, ChevronDown, Shield, Camera,
  TrendingUp, Globe, Zap, Calendar, Smartphone,
  Clock, Timer, Activity, Award, Check
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f4f3ef" }}>
      ...
      <section className="relative min-h-[92vh] flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 lg:pt-36">
          <div className="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 max-w-2xl">
              ...
              <motion.div
                ...
                className="mb-5"
              >
                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold text-white bg-black/35 backdrop-blur-md border border-white/15">
              ...
              <motion.h1
                ...
                style={{ fontSize: "clamp(2.6rem, 5.8vw, 4.2rem)" }}
              >
                Book Your Smart
                <br />
                Sports Field
            ...
            >
              <div className="bg-white rounded-3xl p-6 shadow-2xl max-w-sm ml-auto">
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-8 h-8 rounded-xl bg-[#2d6a4f] text-white flex items-center justify-center font-bold text-xs">
                    <Activity size={16} />
                  </span>
                ...
                <h2 className="text-[#111] font-black text-lg leading-snug mb-4">
                  Book Instantly Only Verified High-Rated Fields
                </h2>

                <Link
                  href="/stadiums"
                  className="flex items-center justify-between w-full px-5 py-3 rounded-full text-white text-xs font-bold transition-all hover:opacity-95"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 mt-12">
          <FadeUp>
            <div className="bg-white rounded-3xl p-6 sm:p-7 shadow-2xl border border-black/[0.04]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                {/* Location Chip */}
                <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-[#f4f3ef]">
                  <MapPin size={16} className="text-[#2d6a4f] flex-shrink-0" />
                ...
                {/* Date Chip */}
                <div className="flex items-center justify-between px-4 py-3 rounded-2xl bg-[#f4f3ef]">
                  <div className="flex items-center gap-3 min-w-0">
                    <Calendar size={16} className="text-[#2d6a4f] flex-shrink-0" />
                    <div className="min-w-0">
                ...
                <div className="flex items-center justify-between px-4 py-3 rounded-2xl bg-[#f4f3ef]">
                  <div className="flex items-center gap-3 min-w-0">
                    <Clock size={16} className="text-[#2d6a4f] flex-shrink-0" />
                    <div className="min-w-0">
                ...
                <div className="flex items-center justify-between px-4 py-3 rounded-2xl bg-[#f4f3ef]">
                  <div className="flex items-center gap-3 min-w-0">
                    <Timer size={16} className="text-[#2d6a4f] flex-shrink-0" />
                    <div className="min-w-0">
                ...
                <Link
                  href="/stadiums"
                  className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-full text-white text-xs font-bold transition-all hover:opacity-90 hover:-translate-y-0.5"
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <SlideIn direction="left">
                <h2 className="text-[#111] font-black text-3xl sm:text-4xl leading-tight mb-4 tracking-tight">
                  The Ultimate Field
                  <br />
                  Selection Is Here
                </h2>
            ...
            <div className="lg:col-span-7">
              <SlideIn direction="right">
                <motion.div
                  ...
                  className="bg-white rounded-3xl p-6 shadow-xl flex flex-col sm:flex-row gap-6 items-center"
                >
                  {/* Left Half — Square Photo */}
                  <div className="relative w-full sm:w-64 aspect-square rounded-2xl overflow-hidden flex-shrink-0">
                    <Image
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between h-full py-1">
                    <div>
                      <div className="text-xs text-[#7a7a7a] font-bold flex items-center gap-1 mb-2">
                        <MapPin size={12} className="text-[#2d6a4f]" />
                        {venues[activeVenue].location}
                      </div>

                      <h3 className="text-xl font-black text-[#111] mb-2 leading-snug">
                    ...
                    <div className="flex items-end justify-between pt-4 border-t border-black/[0.06]">
                      <div>
                        <div className="text-2xl font-black text-[#111] mb-1">
                      ...
                      <Link
                        href="/stadiums"
                        className="w-12 h-12 rounded-full bg-[#2d6a4f] text-white flex items-center justify-center transition-all hover:scale-105 hover:bg-[#1a4731]"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeUp className="mb-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                <h2 className="text-[#111] font-black text-3xl sm:text-4xl leading-tight tracking-tight">
                  Book Perfect Field
                  <br />
              ...
              <div className="max-w-xs text-left md:text-right">
                ...
                <Link
                  href="/stadiums"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-bold text-white transition-all hover:opacity-90"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <ScaleIn delay={0.2}>
              <div className="bg-[#f4f3ef] rounded-3xl p-8 aspect-[4/5] shadow-sm border border-black/[0.04] flex flex-col justify-between">
                ...
                <div>
                  <h3 className="text-xl font-black text-[#111] mb-3 leading-snug">
      ...
      <section className="py-24" style={{ backgroundColor: "#f4f3ef" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 relative rounded-3xl overflow-hidden min-h-[460px] shadow-xl">
              <Image
              ...
              <div className="relative z-10 p-8 sm:p-10 h-full flex flex-col justify-between">
                ...
                <div>
                  <div className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/90 backdrop-blur-md text-[#111] shadow-lg">
                    <span className="text-2xl font-black text-[#2d6a4f]">94%</span>
            ...
            <div className="lg:col-span-5 bg-white rounded-3xl p-8 shadow-xl flex flex-col justify-between">
              <div>
                <h3 className="text-2xl font-black text-[#111] mb-5 leading-tight">
                  Play Seamlessly
                  <br />
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Football", "Basketball", "Volleyball", "Badminton", "Tennis", "Futsal"].map((sport) => (
                    <span
                      key={sport}
                      className="px-3 py-1.5 rounded-full text-xs font-bold text-[#2d6a4f] bg-[#f0faf4] border border-[#2d6a4f]/15"
                    >
                      {sport}
                    </span>
                  ))}
                ...
                <div className="h-44 rounded-2xl bg-[#0d2b1d] overflow-hidden relative mb-6">
                  <Suspense fallback={<div className="h-full w-full bg-[#1a4731]" />}>
                    <SmartPitch3D />
                  </Suspense>
                  <div className="absolute top-2 left-3 text-[10px] font-bold text-[#74c69d] uppercase tracking-wider">
                    AI Veo Cam 3D Radar
                  </div>
                </div>
              ...
              <div className="pt-6 border-t border-black/[0.06] flex justify-end">
                <Link
                  href="/stadiums"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-white text-xs font-bold transition-all hover:opacity-90"
                  style={{ background: "#2d6a4f" }}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeUp className="mb-14">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-bold text-white self-start sm:self-auto"
                style={{ background: "#2d6a4f" }}
              >
                Learn More <ArrowUpRight size={12} />
              </Link>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 relative rounded-3xl overflow-hidden aspect-[4/3] shadow-lg">
              ...
              <div className="absolute bottom-4 left-4">
                <span className="w-10 h-10 rounded-full bg-[#2d6a4f] text-white flex items-center justify-center shadow-lg">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full">
              <motion.div
                ...
                transition={{ duration: 0.4 }}
              >
                <p className="text-[#2d2d2d] text-lg sm:text-xl font-medium leading-relaxed mb-8 italic">
              ...
              <div className="flex items-center gap-3 mt-6">
                <button
                  ...
                  className="w-10 h-10 rounded-full border border-black/15 text-[#111] flex items-center justify-center transition-all hover:border-black/30 disabled:opacity-30"
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-[#2d6a4f] text-white flex items-center justify-center transition-all hover:bg-[#1a4731] disabled:opacity-40"
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6">
              <FadeUp>
                ...
                <p className="text-[#7a7a7a] text-sm leading-relaxed mb-8 max-w-md">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3 text-xs sm:text-sm font-bold text-[#111]">
              ...
              <ScaleIn>
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md rounded-2xl p-6 shadow-xl">
                    <h3 className="text-base sm:text-lg font-black text-[#111] mb-3">
                      Interested in Investing in the Future of Play?
                    </h3>
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-white text-xs font-bold transition-all hover:opacity-90"
                      style={{ background: "#2d6a4f" }}
                    >
          ...
          <FadeUp>
            <div className="relative rounded-3xl overflow-hidden min-h-[420px] shadow-2xl">
              ...
              <div className="relative z-10 p-8 sm:p-12 h-full flex flex-col justify-between">
                <div>
                  <h2 className="text-white font-black text-2xl sm:text-4xl leading-tight max-w-md">
                    Avoid Confusion
                    <br />
                    Book Available Slot
                    <br />
                ...
                <div className="bg-white rounded-2xl p-5 max-w-xs shadow-xl mt-12">
                  <div className="text-[10px] text-[#8a8a8a] font-bold uppercase mb-0.5">Instant Access</div>
                  <div className="text-base font-black text-[#111] mb-3">Book Your Field</div>
                  <Link
                    href="/stadiums"
                    className="flex items-center justify-between w-full px-5 py-2.5 rounded-full text-white text-xs font-bold transition-all hover:opacity-90"
                    style={{ background: "#2d6a4f" }}
                  >
                    Book Now
